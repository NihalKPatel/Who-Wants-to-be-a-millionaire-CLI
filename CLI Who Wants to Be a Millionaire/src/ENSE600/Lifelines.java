...
package ENSE600;
    ...
    public class Lifelines
    {
   	// Static variable declarations
        static String lifelines[] = {"Remove 1 option", "Remove 2 options", "Hint"};
        static int numLifelines = 3;
        static int value = 0;
          ...
          // Variable Declarations
            ...
            if (hasLifeline()) // Checks if they a lifeline and outputs it
            {
                ...
                do // Do while loop to get them to enter a lifeline to use
                {
                    ...
                    if (choice.compareTo("remove 1 option")==0&&lifelines[0].compareTo("")==0) // Sees if they have the 25-75 lifeline
                    {
                        System.out.println("Error! Invalid Entry");
                        exit = true;
                    }
                    else if (choice.compareTo("remove 2 options")==0&&lifelines[1].compareTo("")==0) // Sees if they have the 50-50 lifeline
                    {
                        System.out.println("Error! Invalid Entry");
                        exit = true;
                    }
                ...
                if (choice.compareTo("remove 1 option")==0&&sameturn == false) // 25-75 Lifeline
                {
                    ...
                    else if (choice.compareTo("remove 1 option")==0&&sameturn == true) // Else statement if they have just used 50-50
                    {
                        ...
                        useranswer = scanner.nextLine(); // Gets the users player_answer
                    }
                }
                else if (choice.compareTo("remove 2 option")==0&&lifelines[1]!="") // 50-50
                {
                    if (answer.compareTo(fa)==0) // Checks to see what the answer is
                    {
                        answers = new String[] {b, c, d}; // Creates an array using the remaining possible answers
